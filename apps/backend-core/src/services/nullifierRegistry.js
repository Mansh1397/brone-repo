...
exports.pool = exports.DoubleSpendException = void 0;
exports.processNullifier = processNullifier;
exports.resetNullifierDatabase = resetNullifierDatabase;
const pg_1 = require("pg");
class DoubleSpendException extends Error {
    constructor(message = "Double spend detected") {
        super(message);
        this.name = "DoubleSpendException";
    }
}
exports.DoubleSpendException = DoubleSpendException;
 ...
 */
async function processNullifier(nullifier) {
 ...
 */
async function resetNullifierDatabase() {
    mockDb.clear();
